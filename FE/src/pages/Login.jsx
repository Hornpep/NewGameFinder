...
function Login() {
  return (
    ...
    >
      <div className="w-96 h-auto transparent rounded-lg text-white p-8 absolute top-40 left-1/2 transform -translate-x-1/2 mt-10 border-2 border-white/20 backdrop-blur shadow-[0_0_10px_rgba(0,0,0,0.2)]">
        <form action="">
